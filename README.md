...
Svelte web app for ZotIt — hosted web + browser extensions (Chrome MV3, Firefox MV2).
...
```
ext_data/manifests/   manifest2.json (Firefox), manifest3.json (Chrome)
...
Chrome unpacked load path after packaging: `build/chrome_ext/`
...
- `artifacts/chrome-dist.zip` — Chrome/Edge unpacked extension
- `artifacts/firefox-dist.zip` — Firefox temporary add-on
